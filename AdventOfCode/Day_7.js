...
const calculateBeamSplits = (input) => {

    const lines = input.split("\n").map(line => line.split(""));

    const beams = {[lines[0].findIndex(space => space === "S")]: true};
...
// console.log(calculateBeamSplits(sampleInput));
console.log(calculateBeamSplits(input));
